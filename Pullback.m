...
%% Load Contour
folderPath = 'Data2_Soft_pullback_1/Contours/';  % Replace with your actual folder path
...
folderPathEM = 'Data2_Soft_pullback_1/EM/';  % Replace with your actual folder path
...
centroids = sortrows(centroids, 1);  % If needed
...
rightCentroids = sortrows(rightCentroids, 1);  % Sort by x
